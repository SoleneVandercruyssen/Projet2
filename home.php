...
<!-- ! Section de paragraphes : petite présentation de l'entreprise -->
<section  id="section3"  class="section1">
    <div>
        <div class="paragraphes" id="paragraphe1"  >
            <p> <em>Quanticode</em> est une entreprise innovante spécialisée dans le <em>développement web</em> et <em>la formation numérique</em>. Nous mettons notre expertise au service des entreprises, startups et professionnels souhaitant renforcer leur présence en ligne ou monter en compétences dans les domaines du <em>SEO</em> , du <em>DevOps</em> , du <em>Design</em>  et du <em> Développement Web</em>.</p>
        </div> 
        <br>
        <div class="paragraphes" id="paragraphe2" >
            <p>Notre équipe de développeurs passionnés accompagne les entreprises dans la création de <em> sites web performants, sur mesure et à forte valeur ajoutée</em>, adaptés à leurs objectifs et à leur identité. En parallèle, notre offre de formations est conçue pour transmettre des savoir-faire concrets, actuels et directement applicables, que ce soit pour monter en compétence ou pour amorcer une reconversion professionnelle.</p>
        </div>
        <br>
        <div class="paragraphes" id="paragraphe3" >
            <p> Chez <em>Quanticode</em> , nous croyons en la <em> technologie utile</em>, à la <em> pédagogie pratique </em>et à l'importance <em>d'un accompagnement humain</em>  à chaque étape de votre projet digital. De plus nous croyons fermement que la technologie doit être <em>accessible à tous</em>  et que chacun peut devenir acteur de sa transformation numérique. C'est pourquoi nous proposons des solutions adaptées à chaque besoin, qu'il s'agisse de <em> Développement Web</em>, de <em> SEO</em>, de <em> DevOps</em> ou de <em>Design</em> .</p>
    </div>
</section>
<!-- ! Fin de la section  -->
...
<!-- Animation au défilement de la fenêtre -->
<!-- ! Section coupée en 4 -->
...
<section id="section6" class="section1">
    <div class="carousel-container" >
        <div id="chiffres">
            <h1 id="chiffre" >Nos chiffres clés</h1>
            <p>Chez <strong>Quanticode</strong>, nous sommes fiers de notre parcours et de nos réalisations. Voici quelques chiffres qui témoignent de notre expertise et de notre engagement envers nos clients et apprenants.</p>
        </div>
